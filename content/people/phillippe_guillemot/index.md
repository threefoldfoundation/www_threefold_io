---
title: Phillippe Guillemot
weight: 5
description: Philippe Guillemot, 58, is the former Chief Operating Officer at Alcatel-Lucent SA, Boulogne-Billancourt.
taxonomies:
    people: [phillippe_guillemot]
    memberships: [] # ambassadors
    categories: []
extra:
    imgPath: phillippe_guillemot.jpg
    organizations: []
    countries: [France]
    cities: []
    private: 1
